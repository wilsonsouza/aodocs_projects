...
* Return      Array with twice dimension (first property name second value)
* Created     5-8-2014
* Author      wilson.souza
* Project     BMR Medical
...
* Author      wilson.souza
* Project     BMR Medical
* Description insert child category on root category selected by category identification code
*/
